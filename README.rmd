...
1. Public: A Blockchain in which anyone can participate. Most popular form of Blockchain, but concerning to some in regards to speed and security. Though no real security concerns have been provided, certain industries do not trust that transactions in a public blockchain will be hidden forever and therefore shy away from them.
2. Federated: A Blockchain that limits the participants to a group of companies. Most commonly used in finance when a little more privacy and speed is desired.
3. Private: A Blockchain unique to one organization. Most scalable and fast, but the one with the most overhead. 
